...
public class GooglePlayAPI {
    ...
    private static final String GETUSERACTIVITY_URL = FDFE_URL + "getUserActivity";
    ...
    public ListResponse userActivities(String ogi, Integer offset, Integer numberOfResult) throws IOException {
        ResponseWrapper responseWrapper = executeGETRequest(GETUSERACTIVITY_URL,
                new String[][]{{"ogi", ogi},
                        {"n", (numberOfResult == null) ? null : String.valueOf(numberOfResult)}});
        return responseWrapper.getPayload().getListResponse();
    }
    ...
    private ResponseWrapper executeGETRequest(String path, String[][] datapost) throws IOException {
        ...
        return ResponseWrapper.parseFrom(httpEntity.getContent());
