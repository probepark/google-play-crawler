...
import static com.akdeniz.googleplaycrawler.GooglePlay.*;
import static com.akdeniz.googleplaycrawler.gsf.GoogleServicesFramework.BindAccountResponse;
import static com.akdeniz.googleplaycrawler.gsf.GoogleServicesFramework.LoginResponse;
...
public class googleplay {
    ...
    public static enum COMMAND {
        LIST, DOWNLOAD, CHECKIN, CATEGORIES, SEARCH, PERMISSIONS, REVIEWS, REGISTER, USEGCM, RECOMMENDATIONS, USER_ACTIVITY, DETAILS
    }
	...
	/* =================Reviews Arguments============== */
        ...
        Subparser detailsParser = subparsers.addParser("details", true).description("getting details")
                .setDefault("command", COMMAND.DETAILS);

        detailsParser.addArgument("-d", "--detail").type(String.class).required(true).help("detail url");

        Subparser userActivitiyParser = subparsers.addParser("activities", true).description("getting details")
                .setDefault("command", COMMAND.USER_ACTIVITY);

        userActivitiyParser.addArgument("-o", "--ogi").type(String.class).required(true).help("ogi");
    ...
    private void userActivities() throws Exception {
        login();
